import { _curry1, _curry2, _curry3, _curry } from './internal/_curry'
import flip from './flip'

const curry1Test1 = _curry1((a: number) => a)
const curry1Test2 = curry1Test1(3)

const curry2Test1 = _curry2((a: number, b: string) => a + b)
const curry2Test2 = curry2Test1(3)
const curry2Test3 = curry2Test2('4')

const curry3Test1 = _curry3((a: number, b: string, c: string) => a + b + c)
const curry3Test2 = curry3Test1(3)
const curry3Test3 = curry3Test2('4')
const curry3Test4 = curry3Test3('5')

const curry4Test1 = _curry((a: number, b: string, c: string, d: string) => a + b + c + d)
...
const curry5Test1 = _curry((a: number, b: string, c: string, d: string, e: string) => a)
...
const curry6Test1 = _curry((a: number, b: string, c: string, d: string, e: string, f: string) => a)
...
const curry7Test1 = _curry((a: number, b: string, c: string, d: string, e: string, f: string, g: string) => a)
...
const curry8Test1 = _curry((a: number, b: string, c: string, d: string, e: string, f: string, g: string, h: string) => a)
...
const curry9Test1 = _curry((a: number, b: string, c: string, d: string, e: string, f: string, g: string, h: string, i: string) => a)
...
const curry10Test1 = _curry((a: number, b: string, c: string, d: string, e: string, f: string, g: string, h: string, i: string, j: string) => a)
...
const curry11Test1 = _curry((a: number, b: string, c: string, d: string, e: string, f: string, g: string, h: string, i: string, j: string, k: string) => a)
...
const curry12Test1 = _curry((a: number, b: string, c: string, d: string, e: string, f: string, g: string, h: string, i: string, j: string, k: string,l:string) => a)
...
const _curry2Test1 = _curry((a: number, b: string) => a + b)
const _curry2Test2 = _curry2Test1(3)
const _curry2Test3 = _curry2Test2('4')

const curryNTest1 = _curry((a: number) => a)
const curryNTest2 = curryNTest1(1)

const curryNTest3 = _curry((a: number, b: number) => a + b)
const curryNTest4 = curryNTest3(1)(2)

const curryNTest5 = _curry((a: number, b: number, c: number) => a + b + c)
const curryNTest6 = curryNTest5(1)(2)(3)

const curryNTest7 = _curry((a: number, b: number, c: number, d: number) => a + b + c + d)
const curryNTest8 = curryNTest7(1)(2)(3)(4)

const curryNTest9 = _curry((a: number, b: number) => a + b)
const curryNTest10 = curryNTest9(1)(2)

const curryNTest11 = _curry((a: number, b: number, c: number, d: number, e: number) => a + b + c + d + e)
const curryNTest12 = curryNTest11(1)(2)(3,4)(5)


const curryTest1 = _curry((a: number, b: number, c: number, d: number, e: number) => a + b + c + d + e)
const curryTest2 = curryTest1(1)(2)(3,4)(5)


const curryTest3 = _curry((a: number, b: number, c: number, d: number, e: number, f: number, g: number) => a + b + c + d + e + f + g)
curryTest3(1)(2)(3,4,5)(2, 7)

// any
const arity3 = _curry<[number,string,number],string>((a: number, b: string) => a + b, 3)
arity3(1,'1',2)
